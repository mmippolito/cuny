...
library(tidyverse)
library(RCurl)
nonvoters_csv <- getURL("https://raw.githubusercontent.com/fivethirtyeight/data/master/non-voters/nonvoters_data.csv")
...
While the above results are interesting (albeit disheartening!), it might be even more telling to further break down each of the above by gender, race, income, and level of education; this might indicate which voters feel disenfranchised and why they feel that way, thereby guiding public policy decisions on possibly mitigation efforts.
